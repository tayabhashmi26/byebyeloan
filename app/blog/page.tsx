...
const POSTS = [
  ...
  // --- App-Specific Guides ---
  {
    slug: 'aitemaad-loan-clear-karna',
    title: 'Aitemaad App Loan Clear Karne Ka Tarika — Step by Step Guide',
    excerpt: 'Aitemaad loan overdue ho gaya? Calls aa rahi hain? Step by step settle karein, penalty rokein, aur official NOC hasil karein — Roman Urdu mein complete guide.',
    date: '2026-06-24',
    category: 'App Guide',
  ...
  {
    slug: 'fori-qarza-loan-clear-karna',
    title: 'Fori Qarza App Loan Clear Karne Ka Tarika — Pakistan 2026',
    excerpt: 'Fori Qarza loan overdue? Calls aa rahi hain? Fori Qarza aur Fauri Cash ka farq, settlement process, aur official NOC kaise hasil karein — complete guide.',
    date: '2026-06-24',
    category: 'App Guide',
  ...
  {
    slug: 'abhi-app-loan-clear-karna',
    title: 'Abhi App Loan Clear Karne Ka Tarika — SECP Registered — Pakistan 2026',
    excerpt: 'Abhi app ka loan overdue? SECP registered NBFC hone ka kya matlab hai aur settlement kaise karte hain — salary advance cases bhi cover — complete guide.',
    date: '2026-06-24',
    category: 'App Guide',
  ...
  {
    slug: 'cashbazar-loan-clear-karna',
    title: 'CashBazar Loan Clear Karne Ka Tarika — Pakistan 2026',
    excerpt: 'CashBazar app loan overdue ho gaya? Step by step settle karein, recovery calls ka sach janein, aur official NOC hasil karein — Roman Urdu complete guide.',
    date: '2026-06-24',
    category: 'App Guide',
  ...
  {
    slug: 'daira-loan-clear-karna',
    title: 'Daira App Loan Clear Karne Ka Tarika — Pakistan 2026',
    excerpt: 'Daira loan overdue? Calls aa rahi hain? Step by step settlement process, aapke legal rights, aur official NOC kaise hasil karein — complete Roman Urdu guide.',
    date: '2026-06-24',
    category: 'App Guide',
    categoryColor: '#0c4a6e',
    readTime: '7 min',
  },
  {
