...
import { SITE_URL, PHONE_DISPLAY, WHATSAPP_NUMBER } from '@/lib/constants';
  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-6 px-4" style={{ background: '#F0F4F8' }}>
      ...
      <div className="w-full max-w-2xl mt-5 flex flex-col sm:flex-row gap-3">
        ...
        <WALink
          href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Assalam o Alaikum! Mujhe apna loan clear karna hai.')}`}
