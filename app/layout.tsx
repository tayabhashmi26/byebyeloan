...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Fauri Cash clear',
    'Fori Qarza loan clear',
    'Paisa Guru loan settlement',
    'loan app calls band karna',
    'loan harassment band Pakistan',
  ...
  return (
    <html lang="en">
      ...
      <body className={`${inter.className} antialiased`}>
        ...
        {/* Google Ads Tag */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-18223083898"
